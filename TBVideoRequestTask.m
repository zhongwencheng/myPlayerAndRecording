...
@property (nonatomic        ) NSUInteger      offset;//请求的字节长度

@property (nonatomic        ) NSUInteger      videoLength;//收到的字节长度
@property (nonatomic, strong) NSString        *mimeType;//文件类型

@property (nonatomic, strong) NSURLConnection *connection;
@property (nonatomic, strong) NSMutableArray  *taskArr;

@property (nonatomic, assign) NSUInteger      downLoadingOffset;//正在下载多少
